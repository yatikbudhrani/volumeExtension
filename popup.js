chrome.storage.sync.get("userSettings", (data) => {
  ...
  //Add event listeners
  document
    .getElementById("useMousewheelVolume")
    .addEventListener("change", function () {
      ...
      document.getElementById("overlayFontSizeSlider").disabled =
        !input.checked;
      ...
      document.getElementById("invertModifierKey").disabled =
        !input.checked || !document.getElementById("useModifierKey").checked;
      ...
      chrome.storage.sync.get("userSettings", (result) => {
        chrome.storage.sync.set({
          userSettings: {
            ...result.userSettings,
            useMousewheelVolume: input.checked,
          },
        });
      });
    });
  ...
  document
    .getElementById("incrementSlider")
    .addEventListener("input", function () {
      let input = document.getElementById("incrementSlider");

      document.querySelector(
        "#mousewheelVolumeWrapper .valueDisplay"
      ...
      chrome.storage.sync.get("userSettings", (result) => {
        chrome.storage.sync.set({
          userSettings: {
            ...result.userSettings,
            volumeIncrement: input.value,
            volume: volume,
          },
        });
      });
      document.querySelector("#defaultVolumeWrapper .valueDisplay").innerHTML =
        volume;
    });
  ...
  document
    .getElementById("preciseScroll")
    .addEventListener("input", function () {
      let input = document.getElementById("preciseScroll");

      document.getElementById("preciseScrollState").innerHTML = input.checked
        ? "Precise scroll is enabled"
        : "Precise scroll is disabled";

      chrome.storage.sync.get("userSettings", (result) => {
        chrome.storage.sync.set({
          userSettings: {
            ...result.userSettings,
            usePreciseScroll: input.checked,
          },
        });
      });
    });
  ...
  document
    .getElementById("fullscreenScroll")
    .addEventListener("input", function () {
  ...
  document
    .getElementById("overlayFontSizeSlider")
    .addEventListener("input", function () {
      let input = document.getElementById("overlayFontSizeSlider");

      document.querySelector("#overlayWrapper .valueDisplay").innerHTML =
        input.value;

      chrome.storage.sync.get("userSettings", (result) => {
        chrome.storage.sync.set({
          userSettings: { ...result.userSettings, fontSize: input.value },
        });
      });
    });
  ...
  document
    ...
    .addEventListener("wheel", function (event) {
      ...
      input.value =
        parseInt(input.value) + (event.deltaY / 100) * -1 * input.step; //Gets the direction of the scroll, then divides by 100 to get just the value 1 or -1.
  ...
  document
    ...
    .addEventListener("change", function () {
      ...
      chrome.storage.sync.get("userSettings", (result) => {
        chrome.storage.sync.set({
          userSettings: { ...result.userSettings, fontColor: input.value },
        });
      });
    });

  document
    .getElementById("overlayPositionInput")
    .addEventListener("change", function () {
      ...
      if (input.value === "mouse") {
        ...
        chrome.storage.sync.get("userSettings", (result) => {
          chrome.storage.sync.set({
            userSettings: { ...result.userSettings, useOverlayMouse: true },
          });
        });
        ...
        chrome.storage.sync.get("userSettings", (result) => {
          chrome.storage.sync.set({
            userSettings: { ...result.userSettings, useOverlayMouse: false },
          });
        });
      } else {
        document.getElementById("overlayXPos").disabled = true;
        ...
        xPos.value = value[0];
        document.querySelector("#overlayXPosWrapper .valueDisplay").innerHTML =
          value[0];
        xPos.disabled = true;
        yPos.value = value[1];
        document.querySelector("#overlayYPosWrapper .valueDisplay").innerHTML =
          value[1];
        yPos.disabled = true;
  ...
  document
    ...
    .addEventListener("change", function () {
      ...
      chrome.storage.sync.get("userSettings", (result) => {
        chrome.storage.sync.set({
          userSettings: { ...result.userSettings, overlayXPos: xPos },
        });
      });
    });
    ...
    .addEventListener("wheel", function (event) {
      ...
      chrome.storage.sync.get("userSettings", (result) => {
        chrome.storage.sync.set({
          userSettings: {
            ...result.userSettings,
            overlayXPos: parseInt(input.value),
          },
        });
      });
    });
  ...
  document
    ...
    .addEventListener("change", function () {
      ...
      chrome.storage.sync.get("userSettings", (result) => {
        chrome.storage.sync.set({
          userSettings: { ...result.userSettings, overlayYPos: yPos },
        });
      });
    });
    ...
    .addEventListener("wheel", function (event) {
      ...
      chrome.storage.sync.get("userSettings", (result) => {
        chrome.storage.sync.set({
          userSettings: {
            ...result.userSettings,
            overlayYPos: parseInt(input.value),
          },
        });
      });
    });
  ...
  document
    .getElementById("useDefaultVolume")
    .addEventListener("change", function () {
      ...
      chrome.storage.sync.get("userSettings", (result) => {
        chrome.storage.sync.set({
          userSettings: {
            ...result.userSettings,
            useDefaultVolume: input.checked,
          },
        });
      });
    });
  ...
  document
    ...
    .addEventListener("input", function () {
      ...
      chrome.storage.sync.get("userSettings", (result) => {
        chrome.storage.sync.set({
          userSettings: { ...result.userSettings, volume: input.value },
        });
      });
    });
  ...
  let modifierKeyOnClick = function () {
    document
      .getElementById("modifierKey")
      .removeEventListener("click", modifierKeyOnClick);
    ...
    if (document.getElementById("useModifierKey").checked) {
      ...
      let keyDown = function (event) {
        ...
        chrome.storage.sync.get("userSettings", (result) => {
          chrome.storage.sync.set({
            userSettings: { ...result.userSettings, modifierKey: key },
          });
        });

        document
          .getElementById("modifierKey")
          .addEventListener("click", modifierKeyOnClick);
  ...
  document
    .getElementById("invertModifierKey")
    .addEventListener("input", function () {
      let input = document.getElementById("invertModifierKey");

      document.getElementById("invertModifierKeyState").innerHTML =
        input.checked ? "Inverted" : "Normal";

      chrome.storage.sync.get("userSettings", (result) => {
        chrome.storage.sync.set({
          userSettings: {
            ...result.userSettings,
            invertModifierKey: input.checked,
          },
        });
      });
    });
  ...
  document
    .getElementById("useToggleMuteKey")
    .addEventListener("change", function () {
      ...
      chrome.storage.sync.get("userSettings", (result) => {
        chrome.storage.sync.set({
          userSettings: {
            ...result.userSettings,
            useToggleMuteKey: input.checked,
          },
        });
      });
    });
  ...
  let toggleMuteKeyOnClick = function () {
    document
      .getElementById("toggleMuteKey")
      .removeEventListener("click", toggleMuteKeyOnClick);
    ...
    if (document.getElementById("useToggleMuteKey").checked) {
      ...
      let keyDown = function (event) {
        ...
        chrome.storage.sync.get("userSettings", (result) => {
          chrome.storage.sync.set({
            userSettings: { ...result.userSettings, toggleMuteKey: key },
          });
        });
      ...
      let click = function (event) {
        ...
        setTimeout(function () {
          document
            .getElementById("toggleMuteKey")
            .addEventListener("click", toggleMuteKeyOnClick);
        }, 100);
      };
  ...
  document.getElementById("blacklist").addEventListener("change", function () {
    ...
    document.getElementById("blacklistState").innerHTML = input.checked
    ...
    chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
      ...
      if (input.checked) {
        //Checkbox is checked, meaning the page should not be blacklisted
        blacklist.splice(blacklist.indexOf(url), 1);

        chrome.storage.sync.get("userSettings", (result) => {
          chrome.storage.sync.set({
            userSettings: { ...result.userSettings, blacklist: blacklist },
          });
        });
      } else {
        //Checkbox is not checked, meaning the page should be blacklisted
        blacklist.push(url);
  ...
  document
    .getElementById("useUncappedAudio")
    .addEventListener("input", function () {
      let input = document.getElementById("useUncappedAudio");

      document.getElementById("uncappedAudioState").innerHTML = input.checked
        ? "Volume is uncapped"
        : "Volume is capped";
      ...
      chrome.storage.sync.get("userSettings", (result) => {
        chrome.storage.sync.set({
          userSettings: {
            ...result.userSettings,
            useUncappedAudio: input.checked,
          },
        });
      });
    });
  ...
  document.getElementById("overlayPositionInput").disabled =
    !useMousewheelVolume;
  document.getElementById("preciseScroll").disabled = !useMousewheelVolume;
  document.getElementById("invertModifierKey").disabled =
    !useMousewheelVolume || !document.getElementById("useModifierKey").checked;
  ...
  document.querySelector("#mousewheelVolumeWrapper .valueDisplay").innerHTML =
    volumeIncrement;
  ...
  document.getElementById("preciseScrollState").innerHTML = usePreciseScroll
    ? "Precise scroll is enabled"
    : "Precise scroll is disabled";
  ...
  document.getElementById("uncappedAudioState").innerHTML = useUncappedAudio
    ? "Volume is uncapped"
    : "Volume is capped";
  ...
  document.getElementById("invertModifierKeyState").innerHTML =
    invertModifierKey ? "Inverted" : "Normal";

  chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
    let url = new URL(tabs[0].url).hostname;
    document.getElementById("blacklist").checked = !blacklist.includes(url);
    document.getElementById("blacklistState").innerHTML = !blacklist.includes(
      url
    )
      ? "Enabled on this page"
      : "Disabled on this page";
